...
class SyncService
{
    ...
    public function pull(int $userId, ?string $since, int $pageSize = 200): array
    {
...
use App\Http\Controllers\Api\V1\{AuthController, TaskController, StudyPlanController,
    SportSessionController, CategoryController, ReminderController, ProgressController, SyncController};
